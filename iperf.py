...
SCRIPT_PATH = os.path.abspath("./Macintosh HD/Users/timanderson/Desktop/")
...
GLOBAL_SETTINGS = {
    ...
    "--client": "nyfiosspeed1.west.verizon.net",
    "--time": 20,
    "--port": 5201,
    "--udp": False,
    "--reverse": True,
        ...
        if selection.isdigit():
            ...
            if len(menu_index) > selection >= 0:
                ...
                if index == "--client":
                    ...
                    option = input("--client [{0}]:".format(GLOBAL_SETTINGS[index]))
                    if option.isdigit():
                        option = int(option)
