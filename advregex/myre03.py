...
print("Results of the re.findall(r'wo\w+', wood):", search1)

search2 = re.findall(r"o+", wood)

print("Results of the re.findall(r'o+', wood):", search2)

search3 = re.findall(r"carrots", wood)

print("Results of the re.findall(r'carrots', wood):", search3)
...
print("Results of the re.findall(r'th\w+, hobbit):", search4)

igCAPSsearch5 = re.findall(r"th\w+", hobbit, re.IGNORECASE)

print("Results of the re.findall(r'th\w+, hobbit, re.IGNORECASE):", igCAPSsearch5)
